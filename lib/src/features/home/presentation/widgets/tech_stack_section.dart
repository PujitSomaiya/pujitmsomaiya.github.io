              ...
              children: [
                ...
                Expanded(
                  child: _buildArsenalCard(
                    ...
                    'portfolio.skills.skills_mobile'.tr().split(', ').map((s) => s.toUpperCase()).toList(),
                  ),
                ),
                const SizedBox(width: 24),
                ...
                Expanded(
                  child: _buildArsenalCard(
                    ...
                    'portfolio.skills.skills_architecture'.tr().split(', ').map((s) => s.toUpperCase()).toList(),
                  ),
                ),
                const SizedBox(width: 24),
                ...
                Expanded(
                  child: _buildArsenalCard(
                    ...
                    'portfolio.skills.skills_backend_data'.tr().split(', ').map((s) => s.toUpperCase()).toList(),
                  ),
                ),
              ],
            ),
          ...
          GridView.count(
            ...
            children: [
              _buildMobileStatPanel(
                context,
                'portfolio.skills.category_mobile'.tr().toUpperCase(),
                'portfolio.skills.skills_mobile'.tr(),
                AppColors.neonPurple,
              ),
              _buildMobileStatPanel(
                context,
                'portfolio.skills.category_architecture'.tr().toUpperCase(),
                'portfolio.skills.skills_architecture'.tr(),
                AppColors.cyberGreen,
              ),
              _buildMobileStatPanel(
                context,
                'portfolio.skills.category_backend_data'.tr().toUpperCase(),
                'portfolio.skills.skills_backend_data'.tr(),
