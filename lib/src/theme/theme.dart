...
ThemeData buildLightTheme({required String primaryColorHex}) {
  const colorScheme = ColorScheme(
    ...
    primary: Color(0xFFFAB5B9),
    onPrimary: Color(0xFF4F2327),
    primaryContainer: Color(0xFF310B10),
    onPrimaryContainer: Color(0xFFAD7175),
    secondary: Color(0xFFE2BEBF),
    onSecondary: Color(0xFF412A2B),
    secondaryContainer: Color(0xFF5A4041),
    onSecondaryContainer: Color(0xFFCFADAE),
    tertiary: Color(0xFFB0CADA),
    onTertiary: Color(0xFF1A3340),
    tertiaryContainer: Color(0xFF001B27),
    onTertiaryContainer: Color(0xFF6C8594),
    ...
    outlineVariant: Color(0xFF514344),
    inverseSurface: Color(0xFFECE0DF),
    onInverseSurface: Color(0xFF352F2F),
    inversePrimary: Color(0xFF854F53),
  );
